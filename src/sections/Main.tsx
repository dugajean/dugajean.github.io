  ...
  <main className="flex flex-col gap-8 w-full md:w-3/4 pb-12 md:py-24 px-12 md:pr-16">
    ...
    <div className="flex flex-col gap-4">
      ...
      <Experience>
        ...
        <Experience.Bullet>
          Coordinated the engineering discovery phase of Are Media in behalf of XWP.co. This effort
          earned the company <strong>$1 million+</strong> of revenue and a long term partnership
          with Are Media.
        </Experience.Bullet>
        <Experience.Bullet>
          Took initiative in building a frontend starter kit at XWP.co, which was adopted
          company-wide, speeding up delivery time for frontend work by <strong>40%</strong>.
        </Experience.Bullet>
        <Experience.Bullet>
          ...
          into the product workflow, and speeding up new feature development by <strong>50%</strong>
          .
        </Experience.Bullet>
      </Experience>
      <Experience>
        <Experience.Title>Senior Frontend Engineer, Tally, San Francisco (Remote)</Experience.Title>
      ...
      <Experience>
        ...
        <Experience.Description>
          ...
          "domains", which was the concept of large scale features within the web application. This
          meant facilitating feature development with many different stakeholders to ensure smooth
          delivery for a major migration of our customers.
        </Experience.Description>
        <Experience.Bullet>
